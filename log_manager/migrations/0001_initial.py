    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "unique_together": {
                    ("collection", "config_type", "start_date", "end_date", "value")
                },
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "found_log_files",
                    models.IntegerField(
                        default=0, verbose_name="Number of Found Valid Log Files"
                    ),
                ),
                (
                    "expected_log_files",
                    models.IntegerField(
                        blank=True,
                        null=True,
                        verbose_name="Number of Expected Valid Log Files",
                    ),
                ),
                (
                    "status",
            ...
            options={
                "verbose_name": "Collection Log File Date Count",
                "ordering": ["-date"],
