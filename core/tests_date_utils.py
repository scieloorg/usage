...
from core.utils.date_utils import get_str_date_range
...
class DateUtilsTests(TestCase):
    ...
    def test_get_date_range_with_valid_dates(self):
        ...
        result = get_str_date_range(from_date_str=from_date, until_date_str=until_date)
    ...
    def test_get_date_range_with_days_to_go_back(self):
        ...
        result = get_str_date_range(days_to_go_back=days_to_go_back)
    ...
    def test_get_date_range_with_only_from_date(self):
        ...
        result = get_str_date_range(from_date_str=from_date)
        expected = (
            '2025-02-01',
            '2025-02-08',
        )
    ...
    def test_get_date_range_with_only_until_date(self):
        ...
        result = get_str_date_range(until_date_str=until_date)
        expected = (
            '2025-02-01',
            '2025-02-08',
        )
